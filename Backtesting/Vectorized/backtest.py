...
class vectorizedbacktest:
    def __init__(self, data, window = 0, pct_th =0.52, tca = 'None'):
        self.data = data # price history data, predict signal (2: price rise, 1: price fall, 0: price hold
        ...
        self.window = window # window size for looking back of historical performance
        self.pct_th = pct_th # historical performance confident level threshould to be set
    ...
    def runtest(self):
        ...
        # case one: window size is set, calculate historical performance to filter out bad performanced period
        if self.window>0:
        ...
        # case two: simple map between the signal and position to hold   
        else:
        ...
        # This step is to take into account of transaction cost. For each order, return reduced by half of the spread
